...
export function TrainingSessionCard({ training, showDate, onEditTraining, onPreviewTraining }: CardProps) {
  return <article className={styles.trainingSidebar__trainingCard}>
    ...
    <div className={styles.trainingSidebar__metaLine}><span>{training.time} · {training.durationMinutes} min · {training.bodyWeightKg} kg · Kalorie: {training.caloriesBurned}</span></div>
