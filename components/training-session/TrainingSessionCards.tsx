...
import {
  ...
  hasTrainingGradeContent,
} from "./training-session.utils";

export function TrainingGradeSummary({
  training,
}: {
...
export function TrainingSessionCard({
  ...
  return (
    <article className={styles.trainingSidebar__trainingCard}>
      ...
      <div className={styles.trainingSidebar__trainingButtonHeader}>
        <span className={styles.trainingSidebar__trainingType}>
...
export function TrainingSessionList({
  ...
  return (
    <div className={styles.trainingSidebar__stack}>
      {trainings.length === 0 && (
        <p className={styles.trainingSidebar__helperText}>{emptyMessage}</p>
      )}
